      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <input
            ...
            type="text"
            className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:placeholder-gray-400"
        ...
        <div className="md:col-span-2">
          <label className="flex items-center space-x-2">
            ...
            />
            <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Marcar como favorita</span>
          </label>
        </div>
